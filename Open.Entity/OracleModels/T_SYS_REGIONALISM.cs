...
namespace Open.Entity.Oracle
{
    ...
    /// </summary>    
   [Serializable]
   [SugarTable("T_SYS_REGIONALISM")]
    public class T_SYS_REGIONALISM
    {
        ...
        /// <summary>
        /// 是否是虚结点，如果是虚结点，就不是一个真实的行政区划，而是一个分类[ VOID 是 C# 关键字，所以加一个S]
        /// </summary>
        
        [Description("是否是虚结点，如果是虚结点，就不是一个真实的行政区划，而是一个分类[ VOID 是 C# 关键字，所以加一个S]")]
