...
namespace Open.Utils.Dependency
{
    ...
    internal class Container : IContainer
    {
        ...
        {
            return Open.Utils.Helper.Web.HttpContext?.RequestServices != null ? GetServiceFromHttpContext(type, name) : GetService(type, name);
        }
        ...
        {
            var serviceProvider = Open.Utils.Helper.Web.HttpContext.RequestServices;
            if (name == null)
