...
namespace Open.Utils.Helper
{
    ...
    public static class Reflection
    {
        ...
        /// <param name="t"></param>
        /// <returns></returns>
        public static List<PropertyDescription> GetProperties<T>(T t)
        {
            ...
            foreach (PropertyInfo item in properties)
            {
                ...
                property.Name = item.Name; //名称
                property.Value = item.GetValue(t, null);  //值
                property.Description = ((DescriptionAttribute)Attribute.GetCustomAttribute(item, typeof(DescriptionAttribute))).Description;// 属性描述
                list.Add(property);
            }
            return list;
        }
